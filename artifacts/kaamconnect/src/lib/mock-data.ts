...
export type Worker = {
  ...
  color: string; bio: string;
};

export const workers: Worker[] = [
  { id: 'w1', name: 'Meera Joshi', initials: 'MJ', service: 'Video Editing', rating: 4.9, reviews: 38, jobs: 64, distance: '3.2 km away', price: '₹1,800 / project', skills: ['Reels', 'Color grade', 'Subtitles'], experience: '6 years', availability: 'Available this week', radius: 'Remote + worldwide', verified: true, remote: true, color: 'bg-[#e4a3a0]', bio: 'Story-first editor helping small brands make work that feels as good as it looks.' },
  { id: 'w2', name: 'Arjun Rao', initials: 'AR', service: 'Electrician', rating: 4.8, reviews: 72, jobs: 182, distance: '1.8 km away', price: '₹450 / visit', skills: ['Wiring', 'Fixtures', 'Inverter'], experience: '11 years', availability: 'Today after 4 pm', radius: 'Within 8 km', verified: true, remote: false, color: 'bg-[#f1c76f]', bio: 'On-time electrical work for homes, shops, and the odd mysterious switch.' },
  { id: 'w3', name: 'Kabir Khan', initials: 'KK', service: 'Website Development', rating: 4.7, reviews: 24, jobs: 31, distance: 'Remote', price: '₹2,500 / day', skills: ['React', 'Shopify', 'SEO'], experience: '4 years', availability: 'Available from 18 Jun', radius: 'Remote', verified: true, remote: true, color: 'bg-[#9dbdc0]', bio: 'Builds quick, thoughtful websites for founders who need to ship.' },
  { id: 'w4', name: 'Sana Patel', initials: 'SP', service: 'Home Cleaning', rating: 4.9, reviews: 56, jobs: 120, distance: '4.5 km away', price: '₹700 / session', skills: ['Deep clean', 'Move-out', 'Kitchen'], experience: '8 years', availability: 'Tomorrow morning', radius: 'Within 10 km', verified: true, remote: false, color: 'bg-[#c6b2d5]', bio: 'Careful, reliable home care with a checklist for the places everyone forgets.' },
  { id: 'w5', name: 'Devika Menon', initials: 'DM', service: 'Math Tutoring', rating: 4.8, reviews: 19, jobs: 42, distance: '2.1 km away', price: '₹600 / hour', skills: ['Algebra', 'Calculus', 'SAT'], experience: '7 years', availability: 'Weekday evenings', radius: 'Local + online', verified: true, remote: true, color: 'bg-[#b2c99c]', bio: 'Patient, exam-focused tutoring that makes the next problem feel possible.' },
];
...
export const messages = [
  { id: 'm1', name: 'Fika House', initials: 'FH', subject: 'Video editing brief', preview: 'Could you share a sample with captions?', time: '10:42 am', unread: true, job: 'Edit 8 short videos for a café launch', color: 'bg-[#f1c76f]' },
  { id: 'm2', name: 'Arjun Rao', initials: 'AR', subject: 'Kitchen tap repair', preview: 'I can come by after 4 pm today.', time: 'Yesterday', unread: false, job: 'Fix leaking kitchen tap + check pressure', color: 'bg-[#9dbdc0]' },
  { id: 'm3', name: 'Mitra Clinic', initials: 'MC', subject: 'Landing page', preview: 'The doctor bios are ready to share.', time: 'Mon', unread: false, job: 'Build a simple landing page for a new clinic', color: 'bg-[#c6b2d5]' },
];